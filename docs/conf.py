...
# -*- coding: utf-8 -*-
#
# pypi_oldest_requirements documentation build configuration file, created by
...
htmlhelp_basename = 'pypi_oldest_requirementsdoc'
...
latex_documents = [
    (master_doc, 'pypi_oldest_requirements.tex',
     u'PyPi Oldest Requirements Documentation',
     u'René Fritze', 'manual'),
]
...
man_pages = [
    (master_doc, 'pypi_oldest_requirements',
     u'PyPi Oldest Requirements Documentation',
     [author], 1)
]
